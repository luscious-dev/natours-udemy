...
var displayMap = function displayMap(locations) {
  ...
  locations.forEach(function (loc) {
    ...
    var popup = L.popup().setContent("<p>Day ".concat(loc.day, ": ").concat(loc.description, "</p>"));
    ...
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            e.preventDefault();
            email = document.querySelector('.form__input[type=email]');
            password = document.querySelector('.form__input[type=password]');
            _context.next = 5;
            return (0, _login.login)(email.value, password.value);
          case 5:
          case "end":
            return _context.stop();
        }
